...
export default function Blog() {
  const defaultPosts = [
    {
      id: 1,
      title: "Why I Love Building Data Analysis Projects",
      text: "Working on data analytics projects has shown me how powerful insights can drive smarter decisions and real business impact. Turning raw data into meaningful stories and solutions is my favorite way to create value.",
    },
    {
      id: 2,
